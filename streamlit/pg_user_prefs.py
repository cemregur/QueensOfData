...
def save_pref_values():
    ...
    st.session_state.pref_glisemic_quality = st.session_state.glisemic_quality
    ...
    with st.form(key="user_pref_form"):
        ...
        if ("pref_nutritional_quality" in st.session_state):
            if (str(st.session_state.pref_nutritional_quality) == "Important"):
                st.radio("Nutritional Quality", ["Important", "Not Important"], index=0, horizontal=True, key ="nutritional_quality")
            else:
                st.radio("Nutritional Quality", ["Important", "Not Important"], index=1, horizontal=True, key="nutritional_quality")
        else:
            st.radio("Nutritional Quality", ["Important", "Not Important"], index=1, horizontal=True, key="nutritional_quality")
        #####################################################################
        # Nova Quality
        ...
        # Glisemic Index
        #####################################################################
        if ("pref_glisemic_quality" in st.session_state):
            if (str(st.session_state.pref_glisemic_quality) == "Important"):
                st.radio("Glisemic Quality", ["Important", "Not Important"], index=0, horizontal=True,
                         key="glisemic_quality")
            else:
                st.radio("Glisemic Quality", ["Important", "Not Important"], index=1, horizontal=True,
                         key="glisemic_quality")
        else:
            st.radio("Glisemic Quality", ["Important", "Not Important"], index=1, horizontal=True,
                     key="glisemic_quality")
